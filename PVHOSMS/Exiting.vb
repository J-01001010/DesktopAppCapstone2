...
Public Class Exiting
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        ...
        document.Add("Resident_id_rfid_no", TextBox1.Text)
        document.Add("Plate_no_of_vehicle", TextBox4.Text)
        document.Add("time_out", Label2.Text)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim messageContent As String = "You are exited in the private village of christine vill "
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        document.Add("Non_resident_Qrcode_no", TextBox2.Text)
        document.Add("Plate_no_of_vehicle", TextBox5.Text)
